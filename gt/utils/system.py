...
def load_package_menu(launch_maya_app=False, preferred_version=None):
    ...
    Args:
        ...
        preferred_version (int, optional): If provided and "launch_maya_app" is True, it will attempt to launch
                                           ...
                                           is used instead.
    """
    # core/data/scripts/package_loader.py
    package_loader_script = os.path.join(core_io.DataDirConstants.DIR_SCRIPTS, "package_loader.py")
    file_content = ""
...
def execute_deferred(func, *args, **kwargs):
    ...
    try:
        ...
        logger.debug(f'Unable to use "maya.core.executeDeferred" to call function. Calling it normally. Issue: {e}')
