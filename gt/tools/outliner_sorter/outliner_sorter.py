...
from gt.core.outliner import reorder_up, reorder_down, reorder_front, reorder_back, outliner_sort
from gt.core.outliner import OutlinerSortOptions
...
def build_gui_outliner_sorter():
    ...
    def validate_operation(operation):
        ...
        try:
            ...
            if operation == "reorder_up":
                ...
                outliner_sort(
                    current_selection,
                    operation=OutlinerSortOptions.ATTRIBUTE,
                    attr=current_attr,
    ...
    cmds.rowColumnLayout(
        nc=3, cw=[(1, 10), (2, 200), (3, 55)], cs=[(1, 10), (2, 0), (3, 0)], p=content_main
    )  # Title Column
    ...
    cmds.separator(h=7, style="none")  # Empty Space
    cmds.button(l="Sort by Name", bgc=(0.6, 0.6, 0.6), c=lambda x: validate_operation("sort_name"))
    # cmds.separator(h=10, style='none')  # Empty Space
    ...
    cmds.button(l="Sort by Attribute", bgc=(0.6, 0.6, 0.6), c=lambda x: validate_operation("sort_attribute"))
    cmds.separator(h=10, style="none")  # Empty Space
    ...
    icon = ui_qt.QtGui.QIcon(ui_res_lib.Icon.tool_outliner_sorter)
