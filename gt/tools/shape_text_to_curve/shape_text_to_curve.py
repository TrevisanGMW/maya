...
# Script Name
script_name = "Text Curve Generator"
...
def build_gui_generate_text_curve():
    ...
    # Build UI
    window_gui_generate_text_curve = cmds.window(
        window_name,
    ...
    cmds.button(p=body_column, l="Generate", bgc=(0.6, 0.6, 0.6), c=lambda x: generate_text_curve())
    cmds.separator(h=10, style="none", p=content_main)  # Empty Space
    ...
    icon = ui_qt.QtGui.QIcon(ui_res_lib.Icon.tool_crv_text)
