...
class InfluencesPythonView(metaclass=ui_qt_utils.MayaWindowMeta):
    def __init__(self, parent=None, controller=None, version=None):
        ...
        # Window Title
        self.window_title = "Influence Joints to Python"
        ...
        self.extract_influence_python_btn.setStyleSheet(ui_res_lib.Stylesheet.btn_push_bright)
    ...
    def create_widgets(self):
        ...
        self.extract_influence_python_btn = ui_qt.QtWidgets.QPushButton("Extract Influence Joints to Python")
        self.extract_influence_python_btn.setToolTip("Extracts bound joints (influence) as python code.")
        self.extract_influence_set_btn = ui_qt.QtWidgets.QPushButton("Extract Influence Joints to Selection Set")
        ...
        self.bind_skin_btn = ui_qt.QtWidgets.QPushButton("Bind Skin")
        self.bind_skin_btn.setStyleSheet("padding: 10;")
        self.unbind_skin_btn = ui_qt.QtWidgets.QPushButton("Unbind Skin")
        self.unbind_skin_btn.setStyleSheet("padding: 10;")
        self.non_existent_chk = ui_qt.QtWidgets.QCheckBox("Include Non-Existent Filter")
        self.include_mesh_chk = ui_qt.QtWidgets.QCheckBox("Include Bound Mesh")

    def create_layout(self):
        """Create the layout for the window."""

        top_buttons_layout = ui_qt.QtWidgets.QVBoxLayout()
        two_horizontal_chk_layout = ui_qt.QtWidgets.QHBoxLayout()

        non_existent_chk_layout = ui_qt.QtWidgets.QVBoxLayout()
        non_existent_chk_layout.setAlignment(ui_qt.QtLib.AlignmentFlag.AlignCenter)
        non_existent_chk_layout.addWidget(self.non_existent_chk)
        include_mesh_chk_layout = ui_qt.QtWidgets.QVBoxLayout()
        include_mesh_chk_layout.setAlignment(ui_qt.QtLib.AlignmentFlag.AlignCenter)
