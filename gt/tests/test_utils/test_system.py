...
class TestSetupUtils(unittest.TestCase):
    ...
    @patch("gt.core.setup_utils.get_available_maya_preferences_dirs")
    ...
    @patch("gt.core.setup_utils.generate_user_setup_list")
    ...
    @patch("gt.core.setup_utils.generate_scripts_dir_list")
    ...
    @patch("gt.core.setup_utils.check_installation_integrity")
    @patch("gt.core.setup_utils.remove_legacy_entry_point_from_maya_installs")
    @patch("gt.core.setup_utils.copy_package_loader_to_maya_installs")
    @patch("gt.core.setup_utils.add_entry_point_to_maya_installs")
    @patch("gt.core.setup_utils.remove_previous_install")
    @patch("gt.core.setup_utils.get_package_requirements")
    @patch("gt.core.setup_utils.get_maya_preferences_dir")
    @patch("gt.core.setup_utils.is_script_in_py_maya")
    ...
    @patch("gt.core.setup_utils.remove_package_loader_from_maya_installs")
    @patch("gt.core.setup_utils.remove_entry_point_from_maya_installs")
    @patch("gt.core.setup_utils.get_maya_preferences_dir")
    @patch("gt.core.setup_utils.is_script_in_py_maya")
    ...
    @patch("gt.core.setup_utils.get_installed_core_module_path")
