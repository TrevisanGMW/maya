...
class TestRequestUtils(unittest.TestCase):
    def test_parse_http_request_url(self):
        ...
        result = utils_request.parse_http_request_url(url=url)
    ...
    def test_http_get_request(self, mock_http_connection):
        ...
        response, response_content = utils_request.http_get_request(url=url)
    ...
    def test_read_url_content(self, mock_urlopen):
        ...
        content = utils_request.read_url_content("http://example.com")
        expected = "content"
    ...
    def test_open_url_in_browser(self, mock_webbrowser_open):
        utils_request.open_url_in_browser("http://example.com")
    ...
    def test_get_http_response_type_informational_response(self):
        self.assertEqual(utils_request.get_http_response_type(100), "informational")
        self.assertEqual(utils_request.get_http_response_type(199), "informational")

    def test_get_http_response_type_successful_response(self):
        self.assertEqual(utils_request.get_http_response_type(200), "successful")
        self.assertEqual(utils_request.get_http_response_type(299), "successful")

    def test_get_http_response_type_redirection_message(self):
        self.assertEqual(utils_request.get_http_response_type(300), "redirection")
        self.assertEqual(utils_request.get_http_response_type(399), "redirection")

    def test_get_http_response_type_client_error_response(self):
        self.assertEqual(utils_request.get_http_response_type(400), "client error")
        self.assertEqual(utils_request.get_http_response_type(499), "client error")

    def test_get_http_response_type_server_error_response(self):
        self.assertEqual(utils_request.get_http_response_type(500), "server error")
        self.assertEqual(utils_request.get_http_response_type(599), "server error")

    def test_get_http_response_type_unknown_response_type(self):
        self.assertEqual(utils_request.get_http_response_type(0), "unknown response")
        self.assertEqual(utils_request.get_http_response_type(999), "unknown response")
    ...
    def test_download_file(self, mock_open, mock_urlopen):
        ...
        # Call the function
        utils_request.download_file(
            "http://example.com/file.txt", "downloaded/file.txt", chunk_size=5, callback=mock_callback
        )
    ...
    def test_connected_to_internet(self, mock_socket):
        ...
        result = utils_request.is_connected_to_internet()
    ...
    @patch("gt.utils.request.open_url_in_browser")
    def test_open_package_docs_url_in_browser(self, mocked_open_url):
        utils_request.open_package_docs_url_in_browser()
