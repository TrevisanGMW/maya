...
class TestHierarchyCore(unittest.TestCase):
    ...
    def test_add_offset_transform(self):
        ...
        created_offsets = core_hierarchy.add_offset_transform(target_list=cube_one_node,
    ...
    def test_add_offset_transform_multiple(self):
        ...
        created_offsets = core_hierarchy.add_offset_transform(target_list=[cube_one_node, cube_two_node],
                                                              transform_type="group",
                                                              pivot_source="parent",
                                                              transform_suffix="offset")
    ...
    def test_duplicate_object_children(self):
        ...
        # Duplicate
        duplicated_obj = core_hierarchy.duplicate_object(obj=cube_one, name=None,
    ...
    def test_duplicate_object_naming(self):
        ...
        cmds.parent(cube_two, cube_one)
        # Duplicate
        duplicated_obj = core_hierarchy.duplicate_object(obj=cube_one, name="mocked_cube",
                                                         parent_to_world=True, reset_attributes=True)
    ...
    def test_duplicate_object_parenting(self):
        ...
        duplicated_obj = core_hierarchy.duplicate_object(obj=cube_two, name="world_parent",
                                                         parent_to_world=True, reset_attributes=True)
        expected = '|world_parent'
        self.assertEqual(expected, duplicated_obj)
        # Duplicate; Keep Parent
        duplicated_obj = core_hierarchy.duplicate_object(obj=cube_two, name="keep_parent",
    ...
    def test_get_shape_components_mesh_vtx_full_path(self):
        cube = Node(self.cube_one)
        cube_shape = cmds.listRelatives(cube, shapes=True)
        components_vtx_a = core_hierarchy.get_shape_components(shape=cube_shape[0],
