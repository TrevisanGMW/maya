...
class TestJointCore(unittest.TestCase):
    def setUp(self):
    ...
    def test_orient_joint(self):
        ...
        core_joint.orient_joint(joint_list=joints, aim_axis=(1, 0, 0), up_axis=(0, 1, 0), up_dir=(0, 1, 0))
    ...
    def test_orient_joint_aim_z(self):
        ...
        core_joint.orient_joint(joint_list=joints, aim_axis=(0, 0, 1), up_axis=(0, 1, 0), up_dir=(0, 1, 0))
    ...
    def test_orient_joint_aim_z_up_x(self):
        ...
        core_joint.orient_joint(joint_list=joints, aim_axis=(0, 0, 1), up_axis=(1, 0, 0), up_dir=(0, 1, 0))
    ...
    def test_copy_parent_orients(self):
        ...
        core_joint.copy_parent_orients(joint_list=joint_two)
    ...
    def test_reset_orients(self):
        ...
        core_joint.reset_orients(joint_list=joint_two)
        ...
        core_joint.reset_orients(joint_list=joint_one)
        ...
        core_joint.reset_orients(joint_list=joint_three)
    ...
    def test_convert_joints_to_mesh_selected_one(self):
        joint = cmds.joint()
        cmds.select(joint)
        result = core_joint.convert_joints_to_mesh()
    ...
    def test_convert_joints_to_mesh_str_input(self):
        joint_one = cmds.joint()
        result = core_joint.convert_joints_to_mesh(root_jnt=joint_one)
    ...
    def test_set_joint_radius(self):
        ...
        result = core_joint.set_joint_radius(joints=test_joints, radius=5)
