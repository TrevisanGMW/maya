...
class TestOutlinerCore(unittest.TestCase):
    def setUp(self):
    ...
    def test_reorder_up(self):
        ...
        result = core_outliner.reorder_up(target_list=['cube_b', 'cube_c'])
        expected = True
        self.assertEqual(expected, result)
    ...
    def test_reorder_up_invalid_object(self):
        result = core_outliner.reorder_up(target_list=['mocked_a', 'mocked_b'])
        expected = False
        self.assertEqual(expected, result)
    ...
    def test_reorder_down(self):
        ...
        result = core_outliner.reorder_down(target_list=['cube_b', 'cube_c'])
        expected = True
        self.assertEqual(expected, result)
    ...
    def test_reorder_down_invalid_object(self):
        result = core_outliner.reorder_down(target_list=['mocked_a', 'mocked_b'])
        expected = False
        self.assertEqual(expected, result)
    ...
    def test_reorder_front(self):
        ...
        result = core_outliner.reorder_front(target_list=['cube_b', 'cube_c'])
        expected = True
        self.assertEqual(expected, result)
    ...
    def test_reorder_front_invalid_object(self):
        result = core_outliner.reorder_front(target_list=['mocked_a', 'mocked_b'])
        expected = False
        self.assertEqual(expected, result)
    ...
    def test_reorder_back(self):
        ...
        result = core_outliner.reorder_back(target_list=['cube_a', 'cube_b'])
        expected = True
        self.assertEqual(expected, result)
    ...
    def test_reorder_back_invalid_object(self):
        result = core_outliner.reorder_back(target_list=['mocked_a', 'mocked_b'])
        expected = False
        self.assertEqual(expected, result)
    ...
    def test_outliner_sort_name(self):
        ...
        core_outliner.outliner_sort(target_list=shuffled_cubes)
    ...
    def test_outliner_sort_name_not_ascending(self):
        ...
        core_outliner.outliner_sort(target_list=shuffled_cubes, is_ascending=False)
    ...
    def test_outliner_sort_shuffle(self):
        ...
        core_outliner.outliner_sort(target_list=cubes, operation=core_outliner.OutlinerSortOptions.SHUFFLE)
    ...
    def test_outliner_sort_attribute(self):
        ...
        core_outliner.outliner_sort(target_list=cubes,
