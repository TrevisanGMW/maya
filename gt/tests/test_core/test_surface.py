...
class TestSurfaceCore(unittest.TestCase):
    ...
    def test_is_surface_true(self):
        ...
        result = core_surface.is_surface(surface=sur, accept_transform_parent=True)
        expected = True
        self.assertEqual(expected, result)
        result = core_surface.is_surface(surface=sur_shape, accept_transform_parent=True)
        expected = True
        self.assertEqual(expected, result)
        result = core_surface.is_surface(surface=sur_shape, accept_transform_parent=False)
        expected = True
        self.assertEqual(expected, result)
    ...
    def test_is_surface_false(self):
        ...
        result = core_surface.is_surface(surface=sur, accept_transform_parent=False)
        expected = False
        self.assertEqual(expected, result)
        result = core_surface.is_surface(surface=cube, accept_transform_parent=True)
        expected = False
        self.assertEqual(expected, result)
    ...
    def test_multiply_surface_spans_degrees(self):
        ...
        expected = (3, 3)
        self.assertEqual(expected, result)
        core_surface.multiply_surface_spans(input_surface=surface,
    ...
    def test_create_follicle_custom_uv_position_and_name(self):
        ...
        follicle_tuple = core_surface.create_follicle(input_surface=surface_shape,
                                                      uv_position=(0.3, 0.7),
