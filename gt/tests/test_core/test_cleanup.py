...
from gt.core import cleanup as core_cleanup
cmds = maya_test_tools.cmds


class TestCleanUpCore(unittest.TestCase):
    def setUp(self):
    ...
    def test_delete_unused_nodes(self):
        ...
        num_deleted_nodes = core_cleanup.delete_unused_nodes(verbose=False)
    ...
    def test_delete_nucleus_nodes(self):
        ...
        num_deleted_nodes = core_cleanup.delete_nucleus_nodes(verbose=False, include_fields=False)
    ...
    def test_delete_nucleus_nodes_include_fields(self):
        ...
        self.assertEqual(expected_num_deleted_nodes, num_deleted_nodes)
        num_deleted_nodes = core_cleanup.delete_nucleus_nodes(verbose=False, include_fields=True)
        expected_num_deleted_nodes = len(types_to_test)
        self.assertEqual(expected_num_deleted_nodes, num_deleted_nodes)
    ...
    def test_delete_all_locators(self):
        ...
        num_deleted_nodes = core_cleanup.delete_locators(verbose=False, filter_str=None)
