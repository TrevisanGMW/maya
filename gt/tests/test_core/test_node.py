...
from gt.core import node as core_node
...
class TestNodeCore(unittest.TestCase):
    ...
    def test_create_node_transform(self):
        result = core_node.create_node("transform", name="mockedName", shared=False)
    ...
    def test_create_node_no_name(self):
        result = core_node.create_node("transform", name=None, shared=False)
    ...
    def test_create_node_shared(self):
        result_one = core_node.create_node("transform", name="mockedName", shared=True)
        result_two = core_node.create_node("transform", name="mockedName", shared=True)
        expected = Node("|mockedName")
