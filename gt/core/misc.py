"""
Misc Module - Any utilities that might not clearly fit in an existing category.

Code Namespace:
    core_misc  # import gt.core.misc as core_misc
"""
...
def material_paste():
    ...
    try:
        ...
        logger.debug(str(e))
        cmds.warning(
            "Couldn't paste material. Make sure you copied a material first, "
